...
Edge Add-ons (offen): Partner Center → „Create new extension" → Release-ZIP → „Continue".
...
- Edge: Konto noch nicht registriert, Erstveröffentlichung offen.
