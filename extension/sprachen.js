...
(function (wurzel) {
  ...
  const TEXTE = {
    de: {
      ...
      felder: {
        ...
        'bkl-klammern':       { label: 'einfach',
                                tip: 'Klammerbemerkungen einklappen (Regel: Fundstellen wie BGE-Zitate und Literatur werden eingeklappt; Gesetzesverweise und Entscheidtext bleiben offen)',
                                aria: 'Klammerbemerkungen einklappen' },
    ...
    en: {
      ...
      felder: {
        ...
        'bkl-klammern':       { label: 'simplify',
                                tip: 'Fold parentheticals away (rule: citations such as BGE/ATF references and literature are folded; references to statutes and the court’s own text stay open)',
                                aria: 'Fold parentheticals' },
    ...
    fr: {
      ...
      felder: {
        ...
        'bkl-klammern':       { label: 'simplifier',
                                tip: 'Replier les parenthèses (règle : les références telles que les citations d’ATF et la doctrine sont repliées ; les renvois aux lois et le texte de l’arrêt restent ouverts)',
                                aria: 'Replier les parenthèses' },
        ...
        'bkl-absatz':         { label: 'Espacement des paragraphes',
                                tip: 'Espace supplémentaire après chaque paragraphe (facteur de la taille de police, 0 = valeur du site)',
                                aria: 'Espacement des paragraphes (facteur, 0 = valeur du site)' },
    ...
    it: {
      ...
      felder: {
        ...
        'bkl-klammern':       { label: 'semplificare',
                                tip: 'Ripiegare le parentesi (regola: i riferimenti come le citazioni DTF e la dottrina vengono ripiegati; i rinvii alle leggi e il testo della sentenza restano aperti)',
                                aria: 'Ripiegare le parentesi' },
        ...
        'bkl-absatz':         { label: 'Spaziatura paragrafi',
                                tip: 'Spazio aggiuntivo dopo ogni paragrafo (fattore della dimensione del carattere, 0 = valore del sito)',
                                aria: 'Spaziatura paragrafi (fattore, 0 = valore del sito)' },
  ...
  /* Registrierung im Skript-Kontext. In Firefox-Content-Skripten ist
     globalThis die Sandbox des Skripts und `window` das (Xray-)Fenster der
     Seite – zwei verschiedene Objekte. content.js und popup.js lesen deshalb
     zuerst den nackten Bezeichner BGerReaderSprachen (findet die Sandbox);
     zusätzlich am Fenster hinterlegt, falls ein Kontext nur das kennt.
     Vor 0.11.0 stand die Datei nur an globalThis, und window.BGerReaderSprachen
     blieb in Firefox leer: das Panel blieb deutsch, die Sprachwahl wirkte nicht. */
  wurzel.BGerReaderSprachen = api;
  if (typeof window !== 'undefined' && window !== wurzel) {
    try { window.BGerReaderSprachen = api; } catch (e) { /* Xray verweigert Expandos: der Bezeichner genügt */ }
  }
