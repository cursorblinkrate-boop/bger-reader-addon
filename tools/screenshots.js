...
const Q = U.Q;
const HOCH = 2000; // Höhe der Übersichten
...
const SZENEN = [
  ...
  { datei: '12-schrift-opendyslexic', titel: 'Schriftart OpenDyslexic', text: 'Schrift für Menschen mit Lese-Rechtschreib-Schwäche: schwere Fussenden geben den Buchstaben Halt.', e: { schriftart: 'opendyslexic' } },
  ...
  { datei: '20-hintergrund-sepia', titel: 'Hintergrund Sepia', text: 'Warmer Papierton, weniger Blendung als Weiss.', e: { farbschema: 'sepia' } },
  ...
  { datei: '23-hintergrund-nacht', titel: 'Hintergrund Nacht', text: 'Rötlich abgedunkelt für das Lesen am Abend.', e: { farbschema: 'nacht' } },
  ...
  { datei: '40-klammern-einfach', titel: '„einfach": Fundstellen eingeklappt', text: 'Klammern mit Rechtsprechung und Literatur sind zu einem Pfeil eingeklappt. Gesetzesverweise und Entscheidtext bleiben offen.', e: {} },
  { datei: '41-klammer-aufgeklappt', titel: 'Eine Klammer aufgeklappt', text: 'Ein Klick auf den Pfeil zeigt die Fundstelle, ein zweiter klappt sie wieder ein.', e: {}, foldAuf: true },
  { datei: '42-klammern-aus', titel: '„einfach" ausgeschaltet', text: 'Der Entscheid mit allen Klammern, wie im Original.', e: { klammern: false } },
  ...
  { datei: '60-uebersicht-opendyslexic-sepia', titel: 'Übersicht: OpenDyslexic auf Sepia', text: 'Ein bis zwei Bildschirmseiten Entscheid am Stück.', e: { farbschema: 'sepia' }, hoch: true },
  ...
  try {
    ...
    for (const sz of SZENEN) {
      ...
      try {
        ...
        galerie.push('## ' + sz.titel, '', '![' + sz.titel + '](' + sz.datei + '.png)', '', sz.text, '');
      } catch (e) {
